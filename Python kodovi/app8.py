...
class GrapplerApp(ctk.CTk):
    ...
    def build_main(self):
        ...
        ctk.CTkButton(top, text="EXPORT", width=80, command=self.export_log, fg_color=COLORS["disabled"]).pack(side="right", padx=5)
        ctk.CTkButton(top, text="CLEAR", width=70, command=self.clear_log, fg_color=COLORS["disabled"]).pack(side="right", padx=5)
