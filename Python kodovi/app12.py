...
class SpiRobDesktopApp(ctk.CTk):
    ...
    def build_work_area(self):
        ...
        self.twin_canvas = ctk.CTkCanvas(twin, height=330, bg=COLORS["card_dark"], highlightthickness=0)
    ...
    def draw_digital_twin(self):
        ...
        max_reach = max(82, min(125, available_top, available_bottom, available_side))
