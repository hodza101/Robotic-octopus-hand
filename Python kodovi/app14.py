...
class SpiRobDesktopApp(ctk.CTk):
    ...
    def build_work_area(self):
        ...
        work.grid_columnconfigure(0, weight=0, minsize=560)
        work.grid_columnconfigure(1, weight=1, minsize=620)

        twin = ctk.CTkFrame(work, fg_color=COLORS["card"], corner_radius=18, width=560)
        ...
        self.twin_canvas = ctk.CTkCanvas(twin, width=530, height=330, bg=COLORS["card_dark"], highlightthickness=0)
    ...
    def draw_digital_twin(self):
        ...
        max_reach = max(78, min(112, available_top, available_bottom, available_side))
